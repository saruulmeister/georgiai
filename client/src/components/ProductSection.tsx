        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <div className="relative group">
              ...
              <Card
                className="relative border border-red-100 rounded-2xl shadow-lg hover:shadow-xl transition-all"
          ...
          >
            <div className="relative group">
              ...
              <Card
                className="relative border border-green-100 rounded-2xl shadow-lg hover:shadow-xl transition-all"
