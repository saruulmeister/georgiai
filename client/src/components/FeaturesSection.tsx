  ...
  const features = [
    {
      ...
      description:
        "Faster portfolio reporting with AI-powered automation. Generate comprehensive reports in minutes, not days.",
      align: "left" as const,
    },
    {
      icon: Target,
      title: "High Accuracy",
      description:
        "Our AI engine delivers unprecedented accuracy in data extraction and analysis, eliminating manual errors.",
    ...
    },
    {
      ...
      description:
        "Bank-grade encryption, SOC 2 Type II certified, with role-based access control and complete audit trails.",
      align: "left" as const,
    },
    {
      icon: Brain,
      title: "AI Copilot",
      description:
        "Natural language interface to query your entire portfolio. Ask questions, get instant insights.",
      align: "right" as const,
    },
  ];
